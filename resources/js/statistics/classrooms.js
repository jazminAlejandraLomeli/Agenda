...
import { request_cta_data } from "./request/cta/getdata-cta.js";
import { placesChart } from "./charts/cta/places.js";
import { request_chart_2 } from "./request/cta/get-data-chart-2.js";
import { template_cards } from "./charts/cta/chart_details.js";
    ...
    try {
       ...
       if (!Data.semesters || Data.semesters.length === 0) {
           Swal.fire({
               ...AlertInfo(
                   "Sin datos",
                   "No hay datos para el programa académico o las fechas seleccionadas"
               ),
           });
           return;  
       }
