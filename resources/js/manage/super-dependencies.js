...
import { grid_event } from "./helper/grid-dependencies";
import {
    OpenCloseModal,
    clicBtnCancel,
    ShowModalData,
...
import { requestEditDependencies } from "./helper/request-edit-dependencies.js";
import { requestAddDependency } from "./helper/request-add-dependencies.js";
import {
    confirmDeleteAlert,
    errorAlert,
    successAlert,
...
const clicEdit = (id, group, name) => {
    const Data = {
        ...
        Id_modal: "edit-dependencies",
        Btn_cancel: "#btn-cancel",
    };
    ShowModalData(group, name);
    OpenCloseModal("open-modal", "edit-dependencies"); // Abrir modal
...
*/
function clicAdd() {
    $("#add-dependency").off("click");
    $("#add-dependency").click(function (e) {
        OpenCloseModal("open-modal", "add-dependencies"); // Abrir modal
        const Data = {
            Id: "",
            Old_group: "",
            Old_name: "",
            ...
            Input_name: "#new_dependency",
            Cont_alerta: "#cont-alert-add",
            Id_modal: "add-dependencies",
...
function Request(Option, Id, Group, name) {
    ...
    Swal.fire({
        ...
        if (isConfirmed) {
            ...
            const requestFunction =
                Option == 1 ? requestAddDependency : requestEditDependencies;
...
function initialData() {
    ...
    const table = document.getElementById("tableDependencies");
