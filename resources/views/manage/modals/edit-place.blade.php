<x-modal name="edit-places" maxWidth="lg" :show="false">
    ...
    <div class="px-4 mt-3">
        ...
        <div class="bg-white dark:bg-gray-800 mx-auto mt-5 mb-5">
            ...
            <x-group-form>
                ...
                <x-input-primary name="name" id="name"></x-input-primary>
            ...
            {{-- <div class="flex flex-col space-y-2 w-100 mb-1">
                <label for="color-picker" class="text-gray-600 dark:text-gray-100 text-md font-semibold">
                    Color de referencia al lugar
                </label>
                   
                <div class="flex items-center space-x-3">
                    <!-- Input type="color" -->
                    <input id="color" type="color" value="#ed995a"
                        class="w-15 h-10 border border-gray-100 rounded cursor-pointer" />

                    <!-- Hex color value -->
                    <input id="color-hex" type="text" value="#ff0000" maxlength="7"
                        class="w-24 px-2 py-1 text-sm border border-gray-200 rounded focus:outline-none focus:ring focus:ring-blue-100 focus:border-blue-100 dark:bg-gray-800 dark:text-gray-300" />
                </div>
            </div> --}}
               ...
               <div class="grid grid-cols-2 gap-4">
                <div class="mt-1">
                    ...
                    <div class="grid grid-flow-col auto-cols-max justify-self-startb gap-2">
                        <input id="color" type="color" value="#CD5700"
                            class="w-18 h-10 border border-gray-100 rounded cursor-pointer" />

                        <input  id="color-hex" type="text" value="#CD5700" maxlength="7"
                ...
                <x-group-form>
                    ...
                    <x-select-primary id="text_color">
             ...
             <div class="flex justify-center items-center border border-gray-200 rounded mb-2" id="cont-color-edit">
