<x-modal name="add-dependencies" maxWidth="lg" :show="false">
    ...
    <div class="px-4 mt-3">
        <p class="mt-1 text-sm/6 text-gray-600 mb-2">Escribe los datos perteneceientes a la dependencia y haz clic en <strong>
                Guardar</strong>.
        ...
        <div class="bg-white dark:bg-gray-800 mx-auto mt-5 mb-5">
            ...
            <x-group-form>
                <x-slot name="label">Nombre de la dependencia</x-slot>
                <x-input-primary name="new_event" id="new_dependency"></x-input-primary>
