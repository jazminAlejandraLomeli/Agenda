<x-modal name="add-type-event" maxWidth="lg" :show="false">
    <h2 class="text-lg font-bold  text-center">
        <div class="dark:bg-primary bg-primary px-4 py-3 text-white">
            Agregar un tipo de evento
        </div>
    </h2>
    <div class="px-4 mt-3">
        <p class="mt-1 text-sm/6 text-gray-600 mb-2">Escribe los datos perteneceientes al tipo de evento y haz clic en
            <strong>
                Guardar</strong>.
        ...
        <div class="bg-white dark:bg-gray-800 mx-auto mt-5 mb-5">
            ...
            <x-group-form>
                ...
                <x-input-primary name="new_event-name" id="new_event-name"></x-input-primary>
