<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="flex dark:text-white items-center gap-3">
            ...
            <h2 class="ml-2 text-2xl font-bold">Estadística de las reservaciones de aulas </h2>
        </div>
    </x-slot>
    ...
    <div
        ...
        @include('statistics.classrooms.cards')
        ...
        <div class="grid grid-cols-1 gap-4 px-3 mt-5">
            ...
            <div class="col-span-1 rounded-md shadow-md p-2 ">
                ...
                @include('statistics.classrooms.places-chart')
                {{-- Grafica de chart js --}}
        ...
        <div class="col-span-1 rounded-sm shadow-sm p-2 mt-6">
            ...
            @include('statistics.classrooms.cards-semesters-filter')

            <div class="flex justify-between mb-4">
                <p class="font-semibold text-lg text-gray-700"> Programa acádemico / carrera: <span
                        class="text-gray-800 promgram"> Abogado
                    </span></p>

                <p class="font-semibold text-lg text-gray-700 "> Totales: <span class="count"> 10</span></p>
    ...
    @vite(['resources/js/statistics/classrooms.js'])
