<x-app-layout>
    <x-slot name="header">
        <div class="flex dark:text-white items-center gap-3">
            ...
            <h2 class="ml-2 md:text-2xl text-xl font-bold">Reservar un laboratorio</h2>
        </div>
    </x-slot>
    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg max-w-7xl p-5 md:p-10 mx-auto mt-5 rounded">
        ...
        <form class="grid grid-cols-1 md:grid-cols-2 grid-flow-row" action="{{ route('agenda.store.laboratory') }}" method="POST" id="form-create-event">
            @csrf
            <div  class="col-span-1 md:col-span-1 md:me-5">
                <x-group-form>
                    <x-slot name="label">Nombre de la práctica</x-slot>
                ...
                <x-group-form>
                    <x-slot name="label">Tipo de práctica</x-slot>
                ...
                <x-group-form>
                    <x-slot name="label">Carrera</x-slot>
            ...
            <div class="md:ms-5 col-span-1 md:col-span-1">
                ...
                <x-group-form>
                    <x-slot name="label">Laboratorio</x-slot>
    ...
    @vite(['resources/js/create-event-laboratory.js', 'resources/js/helpers/select2.min.js'])
